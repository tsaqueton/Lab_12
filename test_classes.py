...
class Test:
    ...
    def test_power(self):
        ...
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 0'
        assert self.t2.power() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 0'
    ...
    def test_channel_up(self):
        ...
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 2, Volume = 0'
        assert self.t1.power() is None
        assert self.t1.__str__() == 'TV status: Is on = False, Channel = 2, Volume = 0'
        assert self.t1.channel_up() is None
        assert self.t1.__str__() == 'TV status: Is on = False, Channel = 2, Volume = 0'
        assert self.t1.power() is None
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 2, Volume = 0'
        ...
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 0'
        assert self.t2.channel_up() is None
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t2.power() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t2.channel_up() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 1, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t2.channel_up() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 2, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t2.channel_up() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t2.channel_up() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        ...
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t2.power() is None
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 2, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
        assert self.t2.channel_up() is None
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 2, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 3, Volume = 0'
    ...
    def test_channel_down(self):
        ...
        assert self.t2.channel_down() is None
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = False, Channel = 1, Volume = 0'
        assert self.t2.power() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 0'
    ...
    def test_volume_up(self):
        ...
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
        assert self.t2.volume_up() is None
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 0'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
        assert self.t2.power() is None
        assert self.t2.volume_up() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 1'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
        assert self.t2.power() is None
        assert self.t2.volume_up() is None
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 1'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
        assert self.t2.power() is None
        assert self.t2.volume_up() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
        assert self.t2.volume_up() is None
        assert self.t2.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 0, Volume = 2'
    ...
    def test_volume_down(self):
        ...
        assert self.t1.volume_up() is None
        assert self.t1.volume_down() is None
        assert self.t1.__str__() == 'TV status: Is on = True, Channel = 1, Volume = 1'

        assert self.t1.power() is None
        assert self.t1.__str__() == 'TV status: Is on = False, Channel = 1, Volume = 1'
        ...
        assert self.t1.__str__() == 'TV status: Is on = False, Channel = 1, Volume = 1'
        assert self.t2.power() is None
        assert self.t2.volume_down() is None
        assert self.t2.__str__() == 'TV status: Is on = False, Channel = 0, Volume = 2'
        assert self.t1.__str__() == 'TV status: Is on = False, Channel = 1, Volume = 1'
        assert self.t2.volume_up() is None
        assert self.t2.volume_down() is None
        assert self.t2.volume_up() is None
